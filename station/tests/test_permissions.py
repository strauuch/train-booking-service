...
class PermissionTests(TestCase):
    ...
    def test_admin_can_access_any_method(self):
        ...
        self.assertTrue(
            self.permission_admin_readonly.has_permission(request, view=None)
        )
    ...
    def test_owner_permission_by_user_field(self):
        ...
        self.assertTrue(
            self.permission_owner.has_object_permission(request, view=None, obj=obj)
        )
    ...
    def test_owner_permission_by_order_field(self):
        ...
        mock_obj = MockObj(order=MockOrder(user=owner_user))
        request = self.factory.get("/")
        request.user = owner_user
        self.assertTrue(
            self.permission_owner.has_object_permission(
                request, view=None, obj=mock_obj
            )
        )
